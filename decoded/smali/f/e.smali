...
.method private a()V
    ...
    invoke-virtual {p0, v0}, Lf/e;->setTitle(I)V
    ...
    iget-object v1, p0, Lf/e;->a:Lk/a;

    iget-object v1, v1, Lk/a;->e:Landroid/text/format/Time;
    ...
    iget-object v0, p0, Lf/e;->b:Lconfigs/ActivityConfigTask;
    ...
    invoke-direct/range {v1 .. v6}, Lf/e$1;-><init>(Lf/e;Landroid/widget/TimePicker;Landroid/widget/Spinner;Lcom/xcglobe/xclog/App;Landroid/app/Dialog;)V
...
.method public static a(Lconfigs/ActivityConfigTask;Lk/a;)V
    ...
    invoke-direct {v0, p0}, Lf/e;-><init>(Landroid/content/Context;)V

    iput-object p1, v0, Lf/e;->a:Lk/a;

    iput-object p0, v0, Lf/e;->b:Lconfigs/ActivityConfigTask;

    invoke-direct {v0}, Lf/e;->a()V
