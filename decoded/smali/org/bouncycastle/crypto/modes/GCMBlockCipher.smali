...
.method private initCipher()V
    ...
    invoke-direct {p0, v0, v1, v5, v6}, Lorg/bouncycastle/crypto/modes/GCMBlockCipher;->gHASHPartial([B[BII)V
...
.method public doFinal([BI)I
    ...
    invoke-direct/range {v5 .. v10}, Lorg/bouncycastle/crypto/modes/GCMBlockCipher;->gCTRPartial([BII[BI)V
    ...
    invoke-direct {p0, v4, v5, v10, v6}, Lorg/bouncycastle/crypto/modes/GCMBlockCipher;->gHASHPartial([B[BII)V
    ...
    invoke-static {v2, v3}, Lorg/bouncycastle/crypto/modes/gcm/GCMUtil;->xor([B[B)V
    ...
    invoke-interface {v5, v2, v3, v4}, Lorg/bouncycastle/crypto/modes/gcm/GCMExponentiator;->exponentiateX(J[B)V

    iget-object v2, p0, Lorg/bouncycastle/crypto/modes/GCMBlockCipher;->S_at:[B

    invoke-static {v2, v4}, Lorg/bouncycastle/crypto/modes/gcm/GCMUtil;->multiply([B[B)V
    ...
    invoke-static {v3, v4, v2, v10}, Lorg/bouncycastle/util/Pack;->longToBigEndian(J[BI)V

    iget-wide v3, p0, Lorg/bouncycastle/crypto/modes/GCMBlockCipher;->totalLength:J
    ...
    invoke-interface {v2, v3, v10, v1, v10}, Lorg/bouncycastle/crypto/BlockCipher;->processBlock([BI[BI)I
    ...
    :goto_1
    invoke-direct {p0, v10}, Lorg/bouncycastle/crypto/modes/GCMBlockCipher;->reset(Z)V
...
.method public init(ZLorg/bouncycastle/crypto/CipherParameters;)V
    ...
    iput-object v4, p0, Lorg/bouncycastle/crypto/modes/GCMBlockCipher;->bufBlock:[B
    ...
    iget-object p1, p0, Lorg/bouncycastle/crypto/modes/GCMBlockCipher;->lastKey:[B
    ...
    invoke-static {p1, v4}, Lorg/bouncycastle/util/Arrays;->areEqual([B[B)Z
    ...
    invoke-interface {v1, v5, p2}, Lorg/bouncycastle/crypto/BlockCipher;->init(ZLorg/bouncycastle/crypto/CipherParameters;)V
    ...
    invoke-interface {p2, v1, p1, v4, p1}, Lorg/bouncycastle/crypto/BlockCipher;->processBlock([BI[BI)I

    iget-object p2, p0, Lorg/bouncycastle/crypto/modes/GCMBlockCipher;->multiplier:Lorg/bouncycastle/crypto/modes/gcm/GCMMultiplier;

    iget-object v1, p0, Lorg/bouncycastle/crypto/modes/GCMBlockCipher;->H:[B

    invoke-interface {p2, v1}, Lorg/bouncycastle/crypto/modes/gcm/GCMMultiplier;->init([B)V
